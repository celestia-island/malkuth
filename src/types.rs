//! Lifecycle, supervision & rolling-update types.
//!
//! These are the wire/protocol types that cross process boundaries (HTTP
//! probes, supervisor↔worker IPC, instance-registry queries). The matching
//! runtime behaviour lives alongside in this crate (`lifecycle`, `probes`,
//! `worker`, …).
